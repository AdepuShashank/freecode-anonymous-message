...
suite("funtional tests", function (){
    suite("10 functional tests", function(){
        ...
        test("viewing the 10 most recent with 3 replies each: GET request to /api/threads/{board}",function(done){
            chai
                .request(server)
        ...
        test("reporting a thread: PUT requests to /api/threads/{board}",function(done){
        ...
        test("creating a new reply: POST request to /api/threads/{board}", function(done){
            chai
                .request(server)
                ...
                .end(function(err, res){
                    ...
                    testThread_id = res.body.threads[0].replies[0]._id;
                    done();
                });
        });
        ...
        test("deleting a reply with the correct password: DELETE request to /api/replies/{board} with delete_password", function (done){
            chai
                .request(server)
                .delete("/api/threads/test-board")
                .set("content-type", "application/json")
        ...
        test("deleting a Thread with the correct password: DELETE request to /api/replies/{board} with a valid delete_password", function (done){
            chai
                .request(server)
                .delete("/api/threads/test-board")
                .set("content-type", "application/json")
